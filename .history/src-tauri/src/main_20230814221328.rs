...
pub struct Config {
    ...
    #[serde(skip_serializing)]#[serde(skip_deserializing)]map: Option<HashMap<String, Vec<String>>>,
...
#[tauri::command]
async fn set_layout(app: tauri::AppHandle<>, state: tauri::State<'_, ConfigState>, layout_id: i32, hand_id: i32) -> Result<(), String> {
    ...
    let hand = match hand_id {
        0 => Some(Hand::LeftHand),
        1 => Some(Hand::RightHand),
        _ => None
    };
