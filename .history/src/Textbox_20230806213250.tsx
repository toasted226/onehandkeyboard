...
function Textbox() {
    ...
    const [textAreaSlice, setTextAreaSlice] = useState("");
    ...
    useEffect(() => {
        if (textAreaSlice !== "") {
            setTextAreaValue(textAreaSlice);
        }
    });
            ...
            if (val.length > 1) {
                if (words.index === -1) {
                    ...
                    if (new_words.translated.length === 1) {
                        ...
                        console.log(textAreaValue.slice(0, fi));
                        setTextAreaSlice(textAreaValue.slice(0, fi) + new_words.translated[focusedIndex] + " ");
