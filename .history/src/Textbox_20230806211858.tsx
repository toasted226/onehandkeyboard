            ...
            if (val.length > 1) {
                if (words.index === -1) {
                    ...
                    if (new_words.translated.length === 1) {
                        ...
                        const value = textAreaValue.slice(0, fi) + new_words.translated[focusedIndex] + " ";
                        setTextAreaValue(textAreaValue.slice(0, fi) + new_words.translated[focusedIndex] + " "textAreaValue + value);
